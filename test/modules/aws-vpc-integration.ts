...
describe('VPC Integration Testing', () => {
  ...
  it('checks that cidr have been modified', query(`
...
describe('VPC install/uninstall', () => {
  ...
  it('uninstalls the VPC module', uninstall(
    ['aws_vpc', 'aws_ecs_fargate', 'aws_ecs_simplified', 'aws_security_group', 'aws_rds', 'aws_elb', 'aws_ec2', 'aws_ec2_metadata', 'aws_route53_hosted_zones', 'aws_memory_db', 'aws_acm_request']));
