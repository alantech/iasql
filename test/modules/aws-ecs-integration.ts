  ...
  describe('Docker image', () => {
    ...
    it('adds a new container definition', query(`
      BEGIN;
        ...
        VALUES('${containerNameTag}', '${image}', '${imageTag}', ${containerEssential}, ${containerMemoryReservation}, ${hostPort + 1}, ${containerPort + 1}, '${protocol}', '{ "test": 2}', (select id from aws_task_definition where family = '${tdFamily}' and status is null limit 1), (select id from log_group where log_group_name = '${logGroupName} limit 1'));
        ...
        VALUES('${containerNameDigest}', '${image}', '${imageDigest}', ${containerEssential}, ${containerMemoryReservation}, ${hostPort + 2}, ${containerPort + 2}, '${protocol}', '{ "test": 2}', (select id from aws_task_definition where family = '${tdFamily}' and status is null limit 1), (select id from log_group where log_group_name = '${logGroupName} limit 1'));
      COMMIT;
    `));
