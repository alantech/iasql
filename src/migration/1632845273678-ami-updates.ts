...
export class amiUpdates1632845273678 implements MigrationInterface {
    name = 'amiUpdates1632845273678'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "public"."ami" DROP CONSTRAINT "FK_408b59b6259a7380fcdcc4cc0e4"`);
        await queryRunner.query(`ALTER TABLE "public"."ami" DROP CONSTRAINT "FK_cdb3e5c917620b85fb34a1e5a50"`);
        await queryRunner.query(`ALTER TABLE "public"."product_code" DROP COLUMN "code"`);
        await queryRunner.query(`ALTER TABLE "public"."ami" DROP COLUMN "state_reason_id"`);
        await queryRunner.query(`ALTER TABLE "public"."ami" DROP COLUMN "boot_mode_id"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."ami" ADD "boot_mode_id" integer`);
        await queryRunner.query(`ALTER TABLE "public"."ami" ADD "state_reason_id" integer`);
        await queryRunner.query(`ALTER TABLE "public"."product_code" ADD "code" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "public"."ami" ADD CONSTRAINT "FK_cdb3e5c917620b85fb34a1e5a50" FOREIGN KEY ("state_reason_id") REFERENCES "state_reason"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "public"."ami" ADD CONSTRAINT "FK_408b59b6259a7380fcdcc4cc0e4" FOREIGN KEY ("boot_mode_id") REFERENCES "boot_mode"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
