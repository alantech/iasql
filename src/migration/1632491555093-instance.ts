...
export class instance1632491555093 implements MigrationInterface {
    name = 'instance1632491555093'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "instance" ("id" SERIAL NOT NULL, "instance_id" character varying, "ami_id" integer, "region_id" integer, "instance_type_id" integer, CONSTRAINT "REL_3a9618687034a9bbed91c9c729" UNIQUE ("ami_id"), CONSTRAINT "REL_629601e74b48d0feb492656a59" UNIQUE ("region_id"), CONSTRAINT "REL_83592733879d33f177bb0a29ad" UNIQUE ("instance_type_id"), CONSTRAINT "PK_eaf60e4a0c399c9935413e06474" PRIMARY KEY ("id"))`);
