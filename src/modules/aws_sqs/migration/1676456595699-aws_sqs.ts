  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "queue"
                             (
                                 ...
                                 "fifo_queue"                        boolean           NOT NULL DEFAULT false,
    ...
    await queryRunner.query(`ALTER TABLE "queue"
        ADD CONSTRAINT "FK_09d630f7b20e3ab25429d442639" FOREIGN KEY ("region") REFERENCES "aws_regions" ("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "queue"
        DROP CONSTRAINT "FK_09d630f7b20e3ab25429d442639"`);
