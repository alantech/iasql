...
export class awsMemoryDb1661515951387 implements MigrationInterface {
    name = 'awsMemoryDb1661515951387'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "subnet_group" ("id" SERIAL NOT NULL, "subnet_group_name" character varying NOT NULL, "description" character varying, "arn" character varying, "subnets" character varying array, CONSTRAINT "UQ_129b8295c594237d6cc4adee49a" UNIQUE ("subnet_group_name"), CONSTRAINT "PK_a54731069caf05d2029dc7cd4c2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "memory_db_cluster" ADD CONSTRAINT "FK_ecc3d27115a2a83152a4622b57b" FOREIGN KEY ("subnet_group") REFERENCES "subnet_group"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
