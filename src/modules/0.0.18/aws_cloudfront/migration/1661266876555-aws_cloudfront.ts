...
export class awsCloudfront1661266876555 implements MigrationInterface {
    name = 'awsCloudfront1661266876555'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."distribution_price_class_enum" AS ENUM('PriceClass_100', 'PriceClass_200', 'PriceClass_All')`);
        await queryRunner.query(`CREATE TABLE "distribution" ("id" SERIAL NOT NULL, "distribution_id" character varying, "caller_reference" character varying, "comment" character varying, "enabled" boolean, "is_ipv6_enabled" boolean, "web_acl_id" character varying, "default_cache_behavior" json NOT NULL, "origins" json NOT NULL, "e_tag" character varying, "location" character varying, "price_class" "public"."distribution_price_class_enum" NOT NULL DEFAULT 'PriceClass_All', CONSTRAINT "PK_187eaf203ccf9018df51b40108c" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."distribution_price_class_enum"`);
    }
