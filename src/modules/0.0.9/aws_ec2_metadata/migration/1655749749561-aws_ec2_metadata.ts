...
export class awsEc2Metadata1655749749561 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "registered_instance" ADD CONSTRAINT "check_target_group_instance" CHECK (check_target_group_instance((target_group)::text))`);
    }
