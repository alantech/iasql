...
export class awsRds1655142331183 implements MigrationInterface {
    name = 'awsRds1655142331183'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "parameter_group" ("name" character varying NOT NULL, "arn" character varying, "family" "public"."parameter_group_family_enum" NOT NULL, "description" character varying NOT NULL, CONSTRAINT "UQ_cd5d35716aae42c8f6acb7dc989" UNIQUE ("arn"), CONSTRAINT "PK_d1f1ec0894042fdb4c40575feff" PRIMARY KEY ("name"))`);
        ...
        await queryRunner.query(`ALTER TABLE "parameter" ADD CONSTRAINT "FK_996436925a6b06a81ad07b722b6" FOREIGN KEY ("parameter_group_name") REFERENCES "parameter_group"("name") ON DELETE CASCADE ON UPDATE NO ACTION`);
