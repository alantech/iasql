...
export class awsEcsSimplified1652958371607 implements MigrationInterface {
    name = 'awsEcsSimplified1652958371607'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ecs_simplified" ("app_name" character varying(18) NOT NULL, "desired_count" integer, "app_port" integer NOT NULL, "cpu_mem" "public"."ecs_simplified_cpu_mem_enum", "repository_uri" character varying, "image_tag" character varying, "image_digest" character varying, "public_ip" boolean NOT NULL DEFAULT false, "load_balancer_dns" character varying, CONSTRAINT "UQ_9bf52ef06bff8fe8182e27a5fd8" UNIQUE ("app_name"), CONSTRAINT "CHK_a309c4d1f364127e12e6aaaac2" CHECK (("image_tag" is null and "image_digest" is null) or ("image_tag" is not null and "image_digest" is null) or ("image_tag" is null and "image_digest" is not null)), CONSTRAINT "PK_9bf52ef06bff8fe8182e27a5fd8" PRIMARY KEY ("app_name"))`);
    }
