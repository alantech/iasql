...
export class awsEcsQuickstart1652270006266 implements MigrationInterface {
    name = 'awsEcsQuickstart1652270006266'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ecs_quickstart" ("app_name" character varying NOT NULL, "desired_count" integer, "app_port" integer NOT NULL, "cpu_mem" "public"."ecs_quickstart_cpu_mem_enum", "repository_uri" character varying, "image_tag" character varying, "image_digest" character varying, "public_ip" boolean, "load_balancer_dns" character varying, CONSTRAINT "UQ_38b192448c7b8e62edcc30df4c4" UNIQUE ("app_name"), CONSTRAINT "CHK_1527e69a90243af9326ad93cdc" CHECK (("image_tag" is null and "image_digest" is null) or ("image_tag" is not null and "image_digest" is null) or ("image_tag" is null and "image_digest" is not null)), CONSTRAINT "PK_38b192448c7b8e62edcc30df4c4" PRIMARY KEY ("app_name"))`);
    }
