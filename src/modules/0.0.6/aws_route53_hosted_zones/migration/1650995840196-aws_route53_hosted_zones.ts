...
export class awsRoute53HostedZones1650995840196 implements MigrationInterface {
    name = 'awsRoute53HostedZones1650995840196'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "resource_record_set" ("id" SERIAL NOT NULL, "name" character varying, "record_type" "public"."resource_record_set_record_type_enum" NOT NULL, "record" character varying NOT NULL, "ttl" integer, "parent_hosted_zone_id" integer, CONSTRAINT "PK_6f476cd79c05adaa9a404f8e52a" PRIMARY KEY ("id"))`);
