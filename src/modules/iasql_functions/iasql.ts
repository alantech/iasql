...
async function getInverseQueries(
  ...
  for (const cl of changeLogs) {
    ...
    let processedOriginal: { isPrimary: boolean, isAutogenerated: boolean, key: string, formattedValue: string, isJson: boolean };
    let processedChange: { isPrimary: boolean, isAutogenerated: boolean, key: string, formattedValue: string, isJson: boolean };
    switch (cl.changeType) {
      case AuditLogChangeType.INSERT:
        // todo: return object with primary db columns and the respective formatted values.
        // todo: create delete statement where the `WHERE` clause only takes into account db primary columns.
        break;
      case AuditLogChangeType.DELETE:
        // todo: return object with all properties except db autogenerated columns and the respective formatted values.
        // todo: create insert statement.
        break;
      case AuditLogChangeType.UPDATE:
        // todo: all original properties must be SET with the respective formatted values.
        // todo: get from the change properties only the primary db columns with the respective formatted values.
        // todo: create update statement setting all properties and with a WHERE clause only using changed db primary columns.
        break;
      default:
        break;
    }
...
// /**
//   * @internal
//   * Return a formatted value for the query.
//   */
// async function returnFormattedValue(
//   tableName: string,
//   key: string,
//   value: any,
//   modsIndexedByTable: { [key: string]: ModuleInterface },
