...
export class awsEc2Metadata1669379111210 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "instance_metadata" ADD CONSTRAINT "FK_12f3ab0458b0e1965e9e5cfba7e" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "instance_metadata" DROP CONSTRAINT "FK_12f3ab0458b0e1965e9e5cfba7e"`);
