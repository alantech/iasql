...
begin
  ...
  from json_to_recordset('[
    ...
    {"name": "rollback", "signature": "iasql_rollback()", "description": "Rollback changes done to the database by syncronizing cloud resources", "sample_usage": "SELECT * FROM iasql_rollback()"},
