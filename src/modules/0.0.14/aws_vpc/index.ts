...
const deleteElasticIp = crudBuilder2<EC2, 'releaseAddress'>('releaseAddress', AllocationId => ({ AllocationId }));
const getVpcEndpointGatewayServiceName = crudBuilderFormat<EC2, 'describeVpcEndpointServices', string | undefined>(
