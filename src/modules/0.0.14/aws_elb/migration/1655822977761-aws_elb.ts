...
export class awsElb1655822977761 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "load_balancer_security_groups" ("load_balancer_name" character varying NOT NULL, "security_group_id" integer NOT NULL, CONSTRAINT "PK_c3263aa4b606967900de62e3619" PRIMARY KEY ("load_balancer_name", "security_group_id"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e1020e4ee5063ea1f0b20b3c9c" ON "load_balancer_security_groups" ("load_balancer_name") `
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "listener" ADD CONSTRAINT "FK_f2eeab1baaafa48081a9d4a1467" FOREIGN KEY ("load_balancer_name") REFERENCES "load_balancer"("load_balancer_name") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "listener" ADD CONSTRAINT "FK_04ac33f934f532bfd0227d49997" FOREIGN KEY ("target_group_name") REFERENCES "target_group"("target_group_name") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "load_balancer_security_groups" ADD CONSTRAINT "FK_e1020e4ee5063ea1f0b20b3c9ce" FOREIGN KEY ("load_balancer_name") REFERENCES "load_balancer"("load_balancer_name") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "load_balancer_security_groups" DROP CONSTRAINT "FK_e1020e4ee5063ea1f0b20b3c9ce"`
    );
