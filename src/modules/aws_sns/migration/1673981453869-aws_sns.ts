...
export class awsSns1673981453869 implements MigrationInterface {
  name = 'awsSns1673981453869';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "endpoint" character varying NOT NULL, "region" character varying NOT NULL DEFAULT default_aws_region(), "protocol" character varying NOT NULL, "arn" character varying, "topic" character varying, CONSTRAINT "UQ_0f9d0c2f435f51cd6a5bfd066cd" UNIQUE ("arn"), CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscription" ADD CONSTRAINT "FK_0f6e59c081f44da289e6ca8ef77" FOREIGN KEY ("topic", "region") REFERENCES "topic"("arn","region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "subscription" DROP CONSTRAINT "FK_0f6e59c081f44da289e6ca8ef77"`);
