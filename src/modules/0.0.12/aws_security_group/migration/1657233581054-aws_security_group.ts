...
export class awsSecurityGroup1657233581054 implements MigrationInterface {
    name = 'awsSecurityGroup1657233581054'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "security_group" ("id" SERIAL NOT NULL, "description" character varying, "group_name" character varying NOT NULL, "owner_id" character varying, "group_id" character varying, "vpc_id" integer, CONSTRAINT "UQ_ae05ede7fa10211c645cdac7b14" UNIQUE ("group_name"), CONSTRAINT "PK_08670ec0c305866dbfbfe004cb8" PRIMARY KEY ("id"))`);
