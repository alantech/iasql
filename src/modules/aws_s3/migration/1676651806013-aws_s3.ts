...
export class awsS31676651806013 implements MigrationInterface {
  name = 'awsS31676651806013';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "bucket" ("name" character varying NOT NULL, "policy" json, "created_at" TIMESTAMP, "region" character varying NOT NULL DEFAULT default_aws_region(), CONSTRAINT "uq_bucket_name_region" UNIQUE ("name", "region"), CONSTRAINT "PK_7bd6e5be634c7e3eb1f2474047a" PRIMARY KEY ("name"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "public_access_block" ("block_public_acls" boolean NOT NULL DEFAULT true, "ignore_public_acls" boolean NOT NULL DEFAULT true, "block_public_policy" boolean NOT NULL DEFAULT true, "restrict_public_buckets" boolean NOT NULL DEFAULT true, "bucket_name" character varying NOT NULL, CONSTRAINT "REL_d6fdac79c8d56cc6639b56923f" UNIQUE ("bucket_name"), CONSTRAINT "PK_d6fdac79c8d56cc6639b56923fe" PRIMARY KEY ("bucket_name"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bucket_website" ("index_document" character varying NOT NULL, "error_document" character varying, "bucket_name" character varying NOT NULL, CONSTRAINT "REL_450a65ad6132813c9ca2676436" UNIQUE ("bucket_name"), CONSTRAINT "PK_450a65ad6132813c9ca2676436c" PRIMARY KEY ("bucket_name"))`,
    );
    await queryRunner.query(
