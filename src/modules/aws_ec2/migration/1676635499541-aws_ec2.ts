...
export class awsEc21676635499541 implements MigrationInterface {
  name = 'awsEc21676635499541';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "instance_block_device_mapping" ("id" SERIAL NOT NULL, "device_name" character varying NOT NULL, "instance_id" integer NOT NULL, "volume_id" integer, "region" character varying NOT NULL DEFAULT default_aws_region(), CONSTRAINT "uq_volume" UNIQUE ("volume_id"), CONSTRAINT "PK_b798e916409eefb1193854452e4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "instance_block_device_mapping" ADD CONSTRAINT "FK_619071d52b6f07a99115cc666f0" FOREIGN KEY ("instance_id") REFERENCES "instance"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
