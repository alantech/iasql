...
export class awsEc21676824025053 implements MigrationInterface {
    name = 'awsEc21676824025053'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "instance_block_device_mapping" ("id" SERIAL NOT NULL, "device_name" character varying NOT NULL, "instance_id" integer NOT NULL, "volume_id" integer, "region" character varying NOT NULL DEFAULT default_aws_region(), CONSTRAINT "PK_b798e916409eefb1193854452e4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_33f2e790466c1e3603f32ff37b" ON "instance_block_device_mapping" ("volume_id") WHERE volume_id IS NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "instance_block_device_mapping" ADD CONSTRAINT "FK_619071d52b6f07a99115cc666f0" FOREIGN KEY ("instance_id") REFERENCES "instance"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "instance_block_device_mapping" ADD CONSTRAINT "FK_c3d26dac16915bfd9ecd57524de" FOREIGN KEY ("volume_id") REFERENCES "general_purpose_volume"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "instance_block_device_mapping" ADD CONSTRAINT "FK_fbbd02bffab3b73e12b879bf71e" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "instance" ADD CONSTRAINT "FK_c24c2124cf72257adac2dfa2c8e" FOREIGN KEY ("role_name") REFERENCES "iam_role"("role_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "instance" ADD CONSTRAINT "FK_52f1134c0a4287cdb97af5a9886" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registered_instance" ADD CONSTRAINT "FK_6bf12c7f170e44eeb869e171f0c" FOREIGN KEY ("instance", "region") REFERENCES "instance"("id","region") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registered_instance" ADD CONSTRAINT "FK_b2f419e2eada3ad14e089612720" FOREIGN KEY ("target_group_id") REFERENCES "target_group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registered_instance" ADD CONSTRAINT "FK_65a392a8bbc87257b1251aeb63e" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "key_pair" ADD CONSTRAINT "FK_e2d86caddef571b4984217b4f55" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "general_purpose_volume" ADD CONSTRAINT "FK_6d207f0b3f4bf5f7c162c28cd9e" FOREIGN KEY ("availability_zone") REFERENCES "availability_zone"("name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "general_purpose_volume" ADD CONSTRAINT "FK_6cf180e59980f6cda9aff59af15" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "general_purpose_volume" DROP CONSTRAINT "FK_6cf180e59980f6cda9aff59af15"`);
        await queryRunner.query(`ALTER TABLE "general_purpose_volume" DROP CONSTRAINT "FK_6d207f0b3f4bf5f7c162c28cd9e"`);
        await queryRunner.query(`ALTER TABLE "key_pair" DROP CONSTRAINT "FK_e2d86caddef571b4984217b4f55"`);
        await queryRunner.query(`ALTER TABLE "registered_instance" DROP CONSTRAINT "FK_65a392a8bbc87257b1251aeb63e"`);
        await queryRunner.query(`ALTER TABLE "registered_instance" DROP CONSTRAINT "FK_b2f419e2eada3ad14e089612720"`);
        await queryRunner.query(`ALTER TABLE "registered_instance" DROP CONSTRAINT "FK_6bf12c7f170e44eeb869e171f0c"`);
        ...
        await queryRunner.query(`ALTER TABLE "instance_block_device_mapping" DROP CONSTRAINT "FK_fbbd02bffab3b73e12b879bf71e"`);
        await queryRunner.query(`ALTER TABLE "instance_block_device_mapping" DROP CONSTRAINT "FK_c3d26dac16915bfd9ecd57524de"`);
        await queryRunner.query(`ALTER TABLE "instance_block_device_mapping" DROP CONSTRAINT "FK_619071d52b6f07a99115cc666f0"`);
