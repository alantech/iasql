...
export class awsEcr1662632491461 implements MigrationInterface {
  name = 'awsEcr1662632491461';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "repository_image" ("id" SERIAL NOT NULL, "image_digest" character varying NOT NULL, "image_tag" character varying, "registry_id" character varying, "private_repository" character varying, "public_repository" character varying, CONSTRAINT "PK_b78ff8649cde8d938a7c25f8333" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
