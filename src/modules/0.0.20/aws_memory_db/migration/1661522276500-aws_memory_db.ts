...
export class awsMemoryDb1661522276500 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "memory_db_cluster" ADD CONSTRAINT "FK_ecc3d27115a2a83152a4622b57b" FOREIGN KEY ("subnet_group") REFERENCES "subnet_group"("subnet_group_name") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "memory_db_cluster" DROP CONSTRAINT "FK_ecc3d27115a2a83152a4622b57b"`,
    );
