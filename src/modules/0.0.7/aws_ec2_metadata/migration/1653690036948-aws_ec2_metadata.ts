...
export class awsEc2Metadata1653690036948 implements MigrationInterface {
    name = 'awsEc2Metadata1653690036948'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "instance_metadata" ("id" integer NOT NULL, "instance_id" character varying NOT NULL, "architecture" "public"."instance_metadata_architecture_enum" NOT NULL, "private_ip_address" cidr NOT NULL, "launch_time" TIMESTAMP WITH TIME ZONE NOT NULL, "cpu_cores" integer NOT NULL, "spot" boolean NOT NULL, "mem_size_mb" integer NOT NULL, CONSTRAINT "REL_d3c7f86b7628690e6e68ccebbe" UNIQUE ("id"), CONSTRAINT "PK_e34728db56b9cf43fad3f80039f" PRIMARY KEY ("instance_id"))`);
