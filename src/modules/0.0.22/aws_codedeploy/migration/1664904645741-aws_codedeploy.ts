...
export class awsCodedeploy1664904645741 implements MigrationInterface {
  name = 'awsCodedeploy1664904645741';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "codedeploy_deployment" ("id" SERIAL NOT NULL, "deployment_id" character varying, "description" character varying, "external_id" character varying, "status" "public"."codedeploy_deployment_status_enum", "application_name" character varying NOT NULL, "deployment_group_name" character varying NOT NULL, "revision_id" integer NOT NULL, CONSTRAINT "UQ_b2f00b6e221c03dac7537468e99" UNIQUE ("deployment_id"), CONSTRAINT "PK_e0ac7fcb16e35c7fe3e90ad3dae" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "codedeploy_deployment" ADD CONSTRAINT "FK_869bece9c458ce053feba8496bb" FOREIGN KEY ("deployment_group_name") REFERENCES "codedeploy_deployment_group"("name") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
