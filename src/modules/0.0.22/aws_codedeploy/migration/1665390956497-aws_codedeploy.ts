...
export class awsCodedeploy1665390956497 implements MigrationInterface {
  name = 'awsCodedeploy1665390956497';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "codedeploy_application" ("name" character varying NOT NULL, "application_id" character varying, "compute_platform" "public"."codedeploy_application_compute_platform_enum" NOT NULL DEFAULT 'Server', CONSTRAINT "PK_065aec2451add762a29370b65f4" PRIMARY KEY ("name"))`,
    );
    await queryRunner.query(
