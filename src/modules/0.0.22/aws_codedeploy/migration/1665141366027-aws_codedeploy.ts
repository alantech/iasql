...
export class awsCodedeploy1665141366027 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "codedeploy_deployment" ("id" SERIAL NOT NULL, "deployment_id" character varying, "description" character varying, "external_id" character varying, "status" "public"."codedeploy_deployment_status_enum", "application_name" character varying NOT NULL, "deployment_group_name" character varying NOT NULL, "revision_id" integer, CONSTRAINT "UQ_b2f00b6e221c03dac7537468e99" UNIQUE ("deployment_id"), CONSTRAINT "REL_7d79572e71b3c68231b0d794a5" UNIQUE ("revision_id"), CONSTRAINT "PK_e0ac7fcb16e35c7fe3e90ad3dae" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "codedeploy_deployment" ADD CONSTRAINT "FK_7d79572e71b3c68231b0d794a5a" FOREIGN KEY ("revision_id") REFERENCES "codedeploy_revision"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "codedeploy_deployment" DROP CONSTRAINT "FK_7d79572e71b3c68231b0d794a5a"`);
