...
export class awsCodedeploy1664780608467 implements MigrationInterface {
  name = 'awsCodedeploy1664780608467';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "codedeploy_revision" ADD CONSTRAINT "FK_3acb71f43ea663377faea0debf4" FOREIGN KEY ("application_name") REFERENCES "codedeploy_application"("name") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
