...
export class awsEc21666036680738 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "general_purpose_volume" ADD CONSTRAINT "FK_f4115326fcf8e16edc0ac49f8b1" FOREIGN KEY ("attached_instance_id", "region") REFERENCES "instance"("id","region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "general_purpose_volume" DROP CONSTRAINT "FK_f4115326fcf8e16edc0ac49f8b1"`);
