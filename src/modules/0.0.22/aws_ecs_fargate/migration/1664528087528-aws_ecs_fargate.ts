...
export class awsEcsFargate1664528087528 implements MigrationInterface {
  name = 'awsEcsFargate1664528087528';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "log_group" DROP CONSTRAINT "FK_log_group_region"`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "log_group" ADD CONSTRAINT "FK_log_group_region" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
}
