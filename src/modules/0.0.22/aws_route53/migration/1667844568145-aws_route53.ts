...
export class awsRoute531667844568145 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "alias_target" ADD CONSTRAINT "FK_4c791487240505a79afaad2a41c" FOREIGN KEY ("load_balancer_id") REFERENCES "load_balancer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "resource_record_set" DROP CONSTRAINT "FK_29f0a46b4cccebaf5e3306d9134"`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource_record_set" DROP CONSTRAINT "FK_e0318e494828360d4596194b445"`,
    );
