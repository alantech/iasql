...
export class awsCodebuild1665746759374 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "source_credentials_import" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "source_type" "public"."source_credentials_import_source_type_enum" NOT NULL, "auth_type" "public"."source_credentials_import_auth_type_enum" NOT NULL, "region" character varying NOT NULL DEFAULT default_aws_region(), CONSTRAINT "PK_c1c5d499fdba24ff5ac63f3002c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "codebuild_build_import" ADD CONSTRAINT "FK_0198ad5345b9a8fcd3cac5b31f2" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "source_credentials_import" ADD CONSTRAINT "FK_165729e1b49b52dbd002777fca7" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "source_credentials_import" DROP CONSTRAINT "FK_165729e1b49b52dbd002777fca7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "source_credentials_list" DROP CONSTRAINT "FK_cf3f27bc4e304c5edb53ed4794a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "codebuild_build_import" DROP CONSTRAINT "FK_0198ad5345b9a8fcd3cac5b31f2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "codebuild_build_import" DROP CONSTRAINT "FK_7bb6ac46e08be07c9135f955a6e"`,
    );
    await queryRunner.query(
