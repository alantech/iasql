...
export class awsEcr1667228211509 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "repository_image" ADD CONSTRAINT "FK_465546303cde8039965a523ce97" FOREIGN KEY ("private_repository_id", "private_repository_region") REFERENCES "repository"("id","region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "repository_image" ADD CONSTRAINT "FK_ee0777d152be59ff72d5a549778" FOREIGN KEY ("privateRepositoryRegion") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "repository" ADD CONSTRAINT "FK_93a1a4e1c4fc4aa282463561ea4" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "repository_policy" ADD CONSTRAINT "FK_d63954354967f55ff8b506931fe" FOREIGN KEY ("repository_id", "region") REFERENCES "repository"("id","region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "repository_policy" ADD CONSTRAINT "FK_91306c99185bd327ed6c2c70f92" FOREIGN KEY ("region") REFERENCES "aws_regions"("region") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "repository_policy" DROP CONSTRAINT "FK_91306c99185bd327ed6c2c70f92"`);
        await queryRunner.query(`ALTER TABLE "repository_policy" DROP CONSTRAINT "FK_d63954354967f55ff8b506931fe"`);
        await queryRunner.query(`ALTER TABLE "repository" DROP CONSTRAINT "FK_93a1a4e1c4fc4aa282463561ea4"`);
        await queryRunner.query(`ALTER TABLE "repository_image" DROP CONSTRAINT "FK_ee0777d152be59ff72d5a549778"`);
        await queryRunner.query(`ALTER TABLE "repository_image" DROP CONSTRAINT "FK_73e200bf737f9171cf79db50514"`);
        await queryRunner.query(`ALTER TABLE "repository_image" DROP CONSTRAINT "FK_465546303cde8039965a523ce97"`);
