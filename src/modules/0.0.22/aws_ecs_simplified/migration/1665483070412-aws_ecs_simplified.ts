  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "ecs_simplified"
                             (
                                 ...
                                 "env_variables"        text,
                                 CONSTRAINT "UQ_9bf52ef06bff8fe8182e27a5fd8" UNIQUE ("app_name"),
                                 CONSTRAINT "CHK_a309c4d1f364127e12e6aaaac2" CHECK (("image_tag" is null and "image_digest" is null) or
                                                                                    ("image_tag" is not null and "image_digest" is null) or
                                                                                    ("image_tag" is null and "image_digest" is not null)),
                                 CONSTRAINT "PK_9bf52ef06bff8fe8182e27a5fd8" PRIMARY KEY ("app_name")
                             )`);
  }
