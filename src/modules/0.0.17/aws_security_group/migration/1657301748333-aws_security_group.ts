...
export class awsSecurityGroup1657301748333 implements MigrationInterface {
  name = 'awsSecurityGroup1657301748333';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "security_group" ("id" SERIAL NOT NULL, "description" character varying, "group_name" character varying NOT NULL, "owner_id" character varying, "group_id" character varying, "vpc_id" integer, CONSTRAINT "UQ_groupNameByVpc" UNIQUE ("group_name", "vpc_id"), CONSTRAINT "PK_08670ec0c305866dbfbfe004cb8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
