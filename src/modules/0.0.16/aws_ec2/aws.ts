...
export const describeInstances = crudBuilder2<EC2, 'describeInstances'>('describeInstances', InstanceIds => ({
  InstanceIds,
}));
...
export const getTargetGroups = paginateBuilder<ElasticLoadBalancingV2>(paginateDescribeTargetGroups, 'TargetGroups');
...
const deleteVolumeInternal = crudBuilder2<EC2, 'deleteVolume'>('deleteVolume', VolumeId => ({ VolumeId }));
...
const updateVolumeInternal = crudBuilder2<EC2, 'modifyVolume'>('modifyVolume', input => input);
...
const attachVolumeInternal = crudBuilder2<EC2, 'attachVolume'>('attachVolume', (VolumeId, InstanceId, Device) => ({
  VolumeId,
  InstanceId,
  Device,
}));
...
const detachVolumeInternal = crudBuilder2<EC2, 'detachVolume'>('detachVolume', VolumeId => ({ VolumeId }));
...
export const getParameter = crudBuilder2<SSM, 'getParameter'>('getParameter', Name => ({ Name }));

export const describeImages = crudBuilder2<EC2, 'describeImages'>('describeImages', ImageIds => ({
  ImageIds,
}));
