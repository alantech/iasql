...
export class awsLambda1673457875123 implements MigrationInterface {
  name = 'awsLambda1673457875123';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."lambda_function_runtime_enum" AS ENUM('dotnet6', 'dotnetcore1.0', 'dotnetcore2.0', 'dotnetcore2.1', 'dotnetcore3.1', 'go1.x', 'java11', 'java8', 'java8.al2', 'nodejs', 'nodejs10.x', 'nodejs12.x', 'nodejs14.x', 'nodejs16.x', 'nodejs18.x', 'nodejs4.3', 'nodejs4.3-edge', 'nodejs6.10', 'nodejs8.10', 'provided', 'provided.al2', 'python2.7', 'python3.6', 'python3.7', 'python3.8', 'python3.9', 'ruby2.5', 'ruby2.7')`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "lambda_function_security_groups" ("lambda_function_id" integer NOT NULL, "security_group_id" integer NOT NULL, CONSTRAINT "PK_70f7b122dd48bc798ef03affda9" PRIMARY KEY ("lambda_function_id", "security_group_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_17bc65f40b84a9359b0455e3a4" ON "lambda_function_security_groups" ("lambda_function_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0bc60a723ea0106b86ac8aabeb" ON "lambda_function_security_groups" ("security_group_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "lambda_function_security_groups" ADD CONSTRAINT "FK_17bc65f40b84a9359b0455e3a48" FOREIGN KEY ("lambda_function_id") REFERENCES "lambda_function"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "lambda_function_security_groups" ADD CONSTRAINT "FK_0bc60a723ea0106b86ac8aabeb5" FOREIGN KEY ("security_group_id") REFERENCES "security_group"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "lambda_function_security_groups" DROP CONSTRAINT "FK_0bc60a723ea0106b86ac8aabeb5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "lambda_function_security_groups" DROP CONSTRAINT "FK_17bc65f40b84a9359b0455e3a48"`,
    );
