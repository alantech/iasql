...
export class awsRds1679413172916 implements MigrationInterface {
  name = 'awsRds1679413172916';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "rds" ADD CONSTRAINT "FK_798c0178dd91095e0800a30d2fb" FOREIGN KEY ("db_cluster_id") REFERENCES "db_cluster"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
