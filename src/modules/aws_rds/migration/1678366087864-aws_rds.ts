...
export class awsRds1678366087864 implements MigrationInterface {
  name = 'awsRds1678366087864';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "db_subnet_group" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "arn" character varying, "description" character varying NOT NULL, "subnets" jsonb, "region" character varying NOT NULL DEFAULT default_aws_region(), CONSTRAINT "UQ_5a641e6e9fdf00cecbaeb496f23" UNIQUE ("arn"), CONSTRAINT "subnet_group_id_region" UNIQUE ("id", "region"), CONSTRAINT "subnet_group_name_region" UNIQUE ("name", "region"), CONSTRAINT "PK_687ed5ce05bd63fa341f8f7fe6f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."db_cluster_engine_enum" AS ENUM('aurora', 'aurora-mysql', 'aurora-postgresql', 'MYSQL', 'POSTGRES')`,
    );
    await queryRunner.query(
      `CREATE TABLE "db_cluster" ("id" SERIAL NOT NULL, "db_cluster_identifier" character varying NOT NULL, "allocated_storage" integer, "backup_retention_period" integer, "db_instance_class" character varying, "db_name" character varying NOT NULL, "engine" "public"."db_cluster_engine_enum", "master_user_password" character varying, "master_username" character varying, "port" integer, "publicly_accessible" boolean DEFAULT false, "storage_encrypted" boolean DEFAULT false, "region" character varying NOT NULL DEFAULT default_aws_region(), "availability_zone" character varying NOT NULL, "parameter_group_id" integer, "subnet_group_id" integer, CONSTRAINT "UQ_identifier_region" UNIQUE ("db_cluster_identifier", "region"), CONSTRAINT "PK_4542fa5ac68deb8f3e54dbde217" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "rds_security_groups" ("db_cluster_id" integer NOT NULL, "security_group_id" integer NOT NULL, CONSTRAINT "PK_ec045072eb288b5c9c82aa1536a" PRIMARY KEY ("db_cluster_id", "security_group_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_500e01472da35dbe30f6dbecb3" ON "rds_security_groups" ("db_cluster_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a4080f9f7f3fa99ac9d68dd910" ON "rds_security_groups" ("security_group_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" DROP CONSTRAINT "PK_ec045072eb288b5c9c82aa1536a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" ADD CONSTRAINT "PK_a4080f9f7f3fa99ac9d68dd910a" PRIMARY KEY ("security_group_id")`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_500e01472da35dbe30f6dbecb3"`);
    await queryRunner.query(`ALTER TABLE "rds_security_groups" DROP COLUMN "db_cluster_id"`);
    await queryRunner.query(`ALTER TABLE "rds_security_groups" ADD "db_cluster_id" integer NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" DROP CONSTRAINT "PK_a4080f9f7f3fa99ac9d68dd910a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" ADD CONSTRAINT "PK_ec045072eb288b5c9c82aa1536a" PRIMARY KEY ("security_group_id", "db_cluster_id")`,
    );
    await queryRunner.query(`ALTER TABLE "rds_security_groups" ADD "rds_id" integer NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" DROP CONSTRAINT "PK_ec045072eb288b5c9c82aa1536a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" ADD CONSTRAINT "PK_fde19ac4f12898927d069e97b06" PRIMARY KEY ("security_group_id", "db_cluster_id", "rds_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" DROP CONSTRAINT "PK_fde19ac4f12898927d069e97b06"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" ADD CONSTRAINT "PK_ec045072eb288b5c9c82aa1536a" PRIMARY KEY ("db_cluster_id", "security_group_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" DROP CONSTRAINT "PK_fde19ac4f12898927d069e97b06"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" ADD CONSTRAINT "PK_a0b5fa8fc927a6d22d5e2125e86" PRIMARY KEY ("rds_id", "security_group_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_500e01472da35dbe30f6dbecb3" ON "rds_security_groups" ("db_cluster_id") `,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "db_cluster" ADD CONSTRAINT "FK_64372d28225e95bec67a9607e93" FOREIGN KEY ("availability_zone", "region") REFERENCES "availability_zone"("name","region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "db_cluster" ADD CONSTRAINT "FK_3c601ce451e428741cc05caecc1" FOREIGN KEY ("parameter_group_id", "region") REFERENCES "parameter_group"("id","region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" ADD CONSTRAINT "FK_500e01472da35dbe30f6dbecb37" FOREIGN KEY ("db_cluster_id") REFERENCES "db_cluster"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" DROP CONSTRAINT "FK_500e01472da35dbe30f6dbecb37"`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "db_cluster" DROP CONSTRAINT "FK_3c601ce451e428741cc05caecc1"`);
    await queryRunner.query(`ALTER TABLE "db_cluster" DROP CONSTRAINT "FK_64372d28225e95bec67a9607e93"`);
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_500e01472da35dbe30f6dbecb3"`);
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" DROP CONSTRAINT "PK_a0b5fa8fc927a6d22d5e2125e86"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" ADD CONSTRAINT "PK_fde19ac4f12898927d069e97b06" PRIMARY KEY ("security_group_id", "db_cluster_id", "rds_id")`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "rds_security_groups" DROP COLUMN "rds_id"`);
    await queryRunner.query(
      `ALTER TABLE "rds_security_groups" DROP CONSTRAINT "PK_ec045072eb288b5c9c82aa1536a"`,
    );
    await queryRunner.query(
