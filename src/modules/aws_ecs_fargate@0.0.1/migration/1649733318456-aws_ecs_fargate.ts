...
export class awsEcsFargate1649733318456 implements MigrationInterface {
    name = 'awsEcsFargate1649733318456'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "cluster" ("cluster_name" character varying NOT NULL, "cluster_arn" character varying, "cluster_status" character varying, CONSTRAINT "PK_45ffb6495d51fdc55df46102ce7" PRIMARY KEY ("cluster_name"))`);
        ...
        await queryRunner.query(`CREATE TABLE "service_security_groups" ("service_name" character varying NOT NULL, "security_group_group_name" character varying NOT NULL, CONSTRAINT "PK_c2c1321cfbb698158bc67f00f82" PRIMARY KEY ("service_name", "security_group_group_name"))`);
        await queryRunner.query(`CREATE INDEX "IDX_77d1612919c51ab18afb1be95a" ON "service_security_groups" ("service_name") `);
        await queryRunner.query(`CREATE INDEX "IDX_de60e345351b3bee5279e1eda5" ON "service_security_groups" ("security_group_group_name") `);
        ...
        await queryRunner.query(`ALTER TABLE "container_definition" ADD CONSTRAINT "FK_5b8e931f2150a5a570a809a08e8" FOREIGN KEY ("repository_name") REFERENCES "repository"("repository_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "container_definition" ADD CONSTRAINT "FK_223740ffb1779c07fbad5853e28" FOREIGN KEY ("public_repository_name") REFERENCES "public_repository"("repository_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "container_definition" ADD CONSTRAINT "FK_c5fb01e4d577508d84e3c77a100" FOREIGN KEY ("log_group_name") REFERENCES "log_group"("log_group_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service" ADD CONSTRAINT "FK_5a4fe987d7ad1cae04473db3db8" FOREIGN KEY ("cluster_name") REFERENCES "cluster"("cluster_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "service" ADD CONSTRAINT "FK_3ea3121991d342446c45336ad2e" FOREIGN KEY ("target_group_name") REFERENCES "target_group"("target_group_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "service_security_groups" ADD CONSTRAINT "FK_77d1612919c51ab18afb1be95a2" FOREIGN KEY ("service_name") REFERENCES "service"("name") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "service_security_groups" ADD CONSTRAINT "FK_de60e345351b3bee5279e1eda5f" FOREIGN KEY ("security_group_group_name") REFERENCES "security_group"("group_name") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "service_security_groups" DROP CONSTRAINT "FK_de60e345351b3bee5279e1eda5f"`);
        await queryRunner.query(`ALTER TABLE "service_security_groups" DROP CONSTRAINT "FK_77d1612919c51ab18afb1be95a2"`);
        ...
        await queryRunner.query(`ALTER TABLE "container_definition" DROP CONSTRAINT "FK_c5fb01e4d577508d84e3c77a100"`);
        await queryRunner.query(`ALTER TABLE "container_definition" DROP CONSTRAINT "FK_223740ffb1779c07fbad5853e28"`);
        await queryRunner.query(`ALTER TABLE "container_definition" DROP CONSTRAINT "FK_5b8e931f2150a5a570a809a08e8"`);
        await queryRunner.query(`ALTER TABLE "container_definition" DROP CONSTRAINT "FK_95900c2acc0286c7976d9b729b2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_de60e345351b3bee5279e1eda5"`);
