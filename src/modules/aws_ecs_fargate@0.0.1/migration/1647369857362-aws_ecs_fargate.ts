...
export class awsEcsFargate1647369857362 implements MigrationInterface {
    name = 'awsEcsFargate1647369857362'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "aws_container_definition" ADD CONSTRAINT "FK_22ad0cd60293360bdc81fe67426" FOREIGN KEY ("repository_id") REFERENCES "repository"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "aws_container_definition" ADD CONSTRAINT "FK_753af3f8c3a57a0b09788a3abf5" FOREIGN KEY ("public_repository_id") REFERENCES "public_repository"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
