...
export class awsEcsFargate1647269610406 implements MigrationInterface {
    name = 'awsEcsFargate1647269610406'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "aws_container_definition" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "image" character varying, "tag" character varying, "digest" character varying, "essential" boolean NOT NULL DEFAULT false, "cpu" integer, "memory" integer, "memory_reservation" integer, "host_port" integer, "container_port" integer, "protocol" "public"."aws_container_definition_protocol_enum", "env_variables" text, "task_definition_id" integer, "repository_id" integer, "public_repository_id" integer, "log_group_id" integer, CONSTRAINT "CHK_35feed6ea5b150701b8d6224e7" CHECK (("tag" is null and "digest" is null) or ("tag" is not null and "digest" is null) or ("tag" is null and "digest" is not null)), CONSTRAINT "CHK_84faf9d3827126ceebee8a6117" CHECK (("image" is null and ("repository_id" is not null or "public_repository_id" is not null)) or "image" is not null), CONSTRAINT "PK_82905170a50ef6bbf6931d799a0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`
            create or replace procedure create_container_definition(
                ...
                _image_tag text default null,
                _image_digest text default null,
            ...
            as $$
                ...
                begin
                    ...
                    assert (_image is null and (_ecr_public_repository_name is not null or _ecr_repository_name is not null)), 'If no _image, _ecr_repository_name or _ecr_public_repository_name need to be defined';
                    assert (_image is null and (_image_tag is not null or _image_digest is not null)), 'If no _image, _image_tag or _image_digest need to be defined';
                    ...
                    if _image is not null then
                        insert into aws_container_definition
                            (name, task_definition_id, image, tag, digest, essential, memory_reservation, log_group_id, host_port, container_port, protocol, env_variables)
                        values
                            (_name, td_id, _image, _image_tag, _image_digest, _essential, _memory_reservation, cw_log_group_id, _host_port, _container_port, _protocol, _environment_variables);
                    elsif _ecr_repository_name is not null then
                        ...
                        insert into aws_container_definition
                            (name, task_definition_id, repository_id, tag, digest, essential, memory_reservation, log_group_id, host_port, container_port, protocol, env_variables)
                        values
                            (_name, td_id, ecr_repository_id, _image_tag, _image_digest, _essential, _memory_reservation, cw_log_group_id, _host_port, _container_port, _protocol, _environment_variables);
                        ...
                        insert into aws_container_definition
                            (name, task_definition_id, public_repository_id, tag, digest, essential, memory_reservation, log_group_id, host_port, container_port, protocol, env_variables)
                        values
                            (_name, td_id, ecr_public_repository_id, _image_tag, _image_digest, _essential, _memory_reservation, cw_log_group_id, _host_port, _container_port, _protocol, _environment_variables);
                    end if;
