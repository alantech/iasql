...
export class awsEcsFargate1647371643374 implements MigrationInterface {
    name = 'awsEcsFargate1647371643374'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "aws_service_security_groups" ("service_id" integer NOT NULL, "security_group_id" integer NOT NULL, CONSTRAINT "PK_5da37d12e2679804aaaed127940" PRIMARY KEY ("service_id", "security_group_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_bf60ae14f693daa9272e0a09ac" ON "aws_service_security_groups" ("service_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_7cf180dcd4b3ada30f785484b9" ON "aws_service_security_groups" ("security_group_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "aws_service_security_groups" ADD CONSTRAINT "FK_7cf180dcd4b3ada30f785484b9c" FOREIGN KEY ("security_group_id") REFERENCES "security_group"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "aws_service_security_groups" DROP CONSTRAINT "FK_7cf180dcd4b3ada30f785484b9c"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_7cf180dcd4b3ada30f785484b9"`);
