...
export class awsEcsFargate1649710866644 implements MigrationInterface {
    name = 'awsEcsFargate1649710866644'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "container_definition" ADD CONSTRAINT "FK_469c8e4c77addfb88fc5a40c813" FOREIGN KEY ("task_definition_name") REFERENCES "task_definition"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "container_definition" DROP CONSTRAINT "FK_469c8e4c77addfb88fc5a40c813"`);
