        ...
        await queryRunner.query(`
            ...
            as $$
                ...
                begin
                    ...
                    assert (_environment_variables is not null and json_typeof(_environment_variables) = 'object'), 'Invalid environment variable format. Should be an object with format { [key: string]: string } ';
