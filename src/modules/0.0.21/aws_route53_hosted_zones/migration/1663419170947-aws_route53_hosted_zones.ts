...
export class awsRoute53HostedZones1663419170947 implements MigrationInterface {
    name = 'awsRoute53HostedZones1663419170947'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "load_balancer" DROP CONSTRAINT "check_load_balancer_availability_zones"`);
        ...
        await queryRunner.query(`ALTER TABLE "alias_target" ADD CONSTRAINT "FK_1b41db86df429005a25b9a0ff21" FOREIGN KEY ("load_balancer_name") REFERENCES "load_balancer"("load_balancer_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "load_balancer" ADD CONSTRAINT "check_load_balancer_subnets" CHECK (check_load_balancer_subnets((subnets)::text[]))`);
        await queryRunner.query(`ALTER TABLE "load_balancer" ADD CONSTRAINT "check_load_balancer_availability_zones" CHECK (check_load_balancer_availability_zones(load_balancer_name, availability_zones))`);
    }
