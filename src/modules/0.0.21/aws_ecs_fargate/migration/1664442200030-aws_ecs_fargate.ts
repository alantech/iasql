...
export class awsEcsFargate1664442200030 implements MigrationInterface {
    name = 'awsEcsFargate1664442200030'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "service_security_groups" ("service_name" character varying NOT NULL, "security_group_id" integer NOT NULL, CONSTRAINT "PK_f9e4b5a414490b308112b17bdca" PRIMARY KEY ("service_name", "security_group_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "task_definition" ADD CONSTRAINT "FK_7ea89f0f48f85fb6182e98603a6" FOREIGN KEY ("task_role_name") REFERENCES "iam_role"("role_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_definition" ADD CONSTRAINT "FK_dcf86a08d8805551fe92f7cd8f1" FOREIGN KEY ("execution_role_name") REFERENCES "iam_role"("role_name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
