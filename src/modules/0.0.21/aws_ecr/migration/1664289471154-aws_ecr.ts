...
export class awsEcr1664289471154 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_d8ebc33bfa675482f550961506" ON "repository" ("repository_name", "region") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_48baab7da5512ceed62193dde0" ON "repository_policy" ("id", "region") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "repository_image" ADD CONSTRAINT "FK_d04e4476fcd80553c1a73f9811d" FOREIGN KEY ("private_repository", "private_repository_region") REFERENCES "repository"("repository_name","region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "repository_image" DROP CONSTRAINT "FK_d04e4476fcd80553c1a73f9811d"`,
    );
    await queryRunner.query(
