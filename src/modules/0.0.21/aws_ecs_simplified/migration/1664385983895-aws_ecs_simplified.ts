...
export class awsEcsSimplified1664385983895 implements MigrationInterface {
  name = 'awsEcsSimplified1664385983895';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "service" DROP CONSTRAINT "check_service_subnets"`);
