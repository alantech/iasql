...
export class awsCodebuild1663123579219 implements MigrationInterface {
    name = 'awsCodebuild1663123579219'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "codebuild_build_list" ("id" character varying NOT NULL, "arn" character varying NOT NULL, "build_number" integer, "build_status" "public"."codebuild_build_list_build_status_enum" NOT NULL, "end_time" TIMESTAMP WITH TIME ZONE, "start_time" TIMESTAMP WITH TIME ZONE, "project_name" character varying, CONSTRAINT "PK_58f8424f96ba059f87e7cd55b5d" PRIMARY KEY ("arn"))`);
