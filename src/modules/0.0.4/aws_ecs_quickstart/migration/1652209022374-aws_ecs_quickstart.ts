...
export class awsEcsQuickstart1652209022374 implements MigrationInterface {
    name = 'awsEcsQuickstart1652209022374'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ecs_quickstart" ("app_name" character varying NOT NULL, "desired_count" integer, "app_port" integer NOT NULL, "cpu_mem" "public"."ecs_quickstart_cpu_mem_enum", "repository" character varying, "tag" character varying, "digest" character varying, "public_ip" boolean, "load_balancer_dns" character varying, CONSTRAINT "UQ_38b192448c7b8e62edcc30df4c4" UNIQUE ("app_name"), CONSTRAINT "PK_38b192448c7b8e62edcc30df4c4" PRIMARY KEY ("app_name"))`);
    }
