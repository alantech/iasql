...
export class awsVpc1680099851511 implements MigrationInterface {
  name = 'awsVpc1680099851511';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "subnet" ADD CONSTRAINT "FK_701856b5cac83db222fc36a127e" FOREIGN KEY ("network_acl_id") REFERENCES "network_acl"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
