...
export class awsVpc1679648998918 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "network_acl" ("id" SERIAL NOT NULL, "network_acl_id" character varying, "is_default" boolean NOT NULL DEFAULT false, "entries" json, "tags" json, "region" character varying NOT NULL DEFAULT default_aws_region(), "vpc_id" integer NOT NULL, CONSTRAINT "PK_08d30551742efc4f5fa200dacda" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "network_acl" ADD CONSTRAINT "FK_0f9f559664c88e50857392a1dc4" FOREIGN KEY ("vpc_id", "region") REFERENCES "vpc"("id","region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
