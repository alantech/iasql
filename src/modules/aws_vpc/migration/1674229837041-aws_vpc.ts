...
export class awsVpc1674229837041 implements MigrationInterface {
  name = 'awsVpc1674229837041';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "route" ("id" SERIAL NOT NULL, "destination_cidr_block" character varying, "destination_ipv6_cidr_block" character varying, "destination_prefix_list_id" character varying, "egress_only_internet_gateway_id" character varying, "instance_id" character varying, "instance_owner_id" character varying, "nat_gateway_id" character varying, "transit_gateway_id" character varying, "local_gateway_id" character varying, "carrier_gateway_id" character varying, "network_interface_id" character varying, "vpc_peering_connection_id" character varying, "core_network_arn" character varying, "route_table_id" integer, "internet_gateway_id" integer, CONSTRAINT "PK_08affcd076e46415e5821acf52d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "route" ADD CONSTRAINT "FK_915f4d462c7a03efa5b3d3015ec" FOREIGN KEY ("internet_gateway_id") REFERENCES "internet_gateway"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "route" DROP CONSTRAINT "FK_915f4d462c7a03efa5b3d3015ec"`);
