...
export class awsVpc1679674934515 implements MigrationInterface {
  name = 'awsVpc1679674934515';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "subnet" ADD CONSTRAINT "FK_67a874ed15b81ee5f7eeb3c8086" FOREIGN KEY ("network_acl_id", "region") REFERENCES "network_acl"("id","region") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
