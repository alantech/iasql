...
export class awsVpc1674214933491 implements MigrationInterface {
  name = 'awsVpc1674214933491';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "route" ADD CONSTRAINT "FK_99d37d1a128c82c00eda4b6be44" FOREIGN KEY ("gateway_id_id") REFERENCES "internet_gateway"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "route" DROP CONSTRAINT "FK_99d37d1a128c82c00eda4b6be44"`);
