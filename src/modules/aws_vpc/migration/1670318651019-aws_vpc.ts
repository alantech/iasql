...
export class awsVpc1670318651019 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "route_table" ("id" SERIAL NOT NULL, "route_table_id" character varying, "vpc_id" integer NOT NULL, "tags" json, "region" character varying NOT NULL DEFAULT default_aws_region(), CONSTRAINT "uq_route_table_vpc" UNIQUE ("id", "vpc_id"), CONSTRAINT "PK_122d1d594e0cc44b4f62baa0934" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
