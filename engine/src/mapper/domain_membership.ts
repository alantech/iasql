...
export const DomainMembershipMapper = new EntityMapper(DomainMembership, {
  domain: (dm: DomainMembershipAWS) => dm.Domain ?? null,
  status: (dm: DomainMembershipAWS) => dm.Status ?? null,
  fqdn: (dm: DomainMembershipAWS) => dm.FQDN ?? null,
  iamRoleName: (dm: DomainMembershipAWS) => dm.IAMRoleName ?? null,
}, {
