...
export class targetGroupSp1636655461356 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`drop function create_target_group;`);
    // Example of use: call create_target_group('test-sp', 'ip', 8888, 'vpc-41895538', 'TCP');
    await queryRunner.query(`
      create or replace procedure create_target_group(
        _name text,
      ...
      as $$
        ...
        begin
          ...
          raise info 'target_group_id = %', target_group_id;
        end;
      $$;
    `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`drop procedure create_target_group;`);
