...
export class container1634822632356 implements MigrationInterface {
    name = 'container1634822632356'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "container_environment_environmet_variable" ("container_id" integer NOT NULL, "environmet_variable_id" integer NOT NULL, CONSTRAINT "PK_825f457e3bdccd6bfe4a3a47456" PRIMARY KEY ("container_id", "environmet_variable_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_5bce8e5072edab99cbd2d20826" ON "container_environment_environmet_variable" ("container_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_1f0cd7ad3044cc98155f82a2ac" ON "container_environment_environmet_variable" ("environmet_variable_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "container_environment_environmet_variable" ADD CONSTRAINT "FK_5bce8e5072edab99cbd2d208261" FOREIGN KEY ("container_id") REFERENCES "container"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "container_environment_environmet_variable" ADD CONSTRAINT "FK_1f0cd7ad3044cc98155f82a2ac4" FOREIGN KEY ("environmet_variable_id") REFERENCES "environmet_variable"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "container_environment_environmet_variable" DROP CONSTRAINT "FK_1f0cd7ad3044cc98155f82a2ac4"`);
        await queryRunner.query(`ALTER TABLE "container_environment_environmet_variable" DROP CONSTRAINT "FK_5bce8e5072edab99cbd2d208261"`);
        ...
        await queryRunner.query(`DROP TABLE "container_environment_environmet_variable"`);
