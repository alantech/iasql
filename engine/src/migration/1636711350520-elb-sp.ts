...
export class elbSp1636711350520 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP function create_load_balancer;`);
    // Example of use: call create_load_balancer('test-sp2', 'internal', 'vpc-41895538', 'network', array['subnet-68312820', 'subnet-a58a84c3'], 'ipv4');
    await queryRunner.query(`
      create or replace procedure create_load_balancer(
        _name text,
      ...
      as $$
        ...
        begin
          ...
          insert into elb
            (load_balancer_name, scheme, vpc_id, elb_type, availability_zone_id, ip_address_type)
          values
            (_name, _scheme, elb_vpc_id, _elb_type, aux_az_id, _ip_address_type)
          ...
          select subnet_id into sn_id
          from elb_subnets_subnet
          where elb_id = load_balancer_id
          limit 1;
          ...
          from elb_availability_zones_availability_zone
          where elb_id = load_balancer_id
          limit 1;
          ...
          select security_group_id into sg_id
          from elb_security_groups_security_group
          where elb_id = load_balancer_id
          limit 1;
          ...
          raise info 'elb_id = %', load_balancer_id;
        end;
      $$;
    `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP procedure create_load_balancer;`);
