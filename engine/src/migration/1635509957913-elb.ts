...
export class elb1635509957913 implements MigrationInterface {
    name = 'elb1635509957913'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "elb" ("id" SERIAL NOT NULL, "load_balancer_arn" character varying, "dns_name" character varying, "canonical_hosted_zone_id" character varying, "created_time" TIMESTAMP WITH TIME ZONE, "load_balancer_name" character varying NOT NULL, "scheme" "public"."elb_scheme_enum" NOT NULL, "state" "public"."elb_state_enum", "elb_type" "public"."elb_elb_type_enum" NOT NULL, "ip_address_type" "public"."elb_ip_address_type_enum" NOT NULL, "customer_owned_ipv4_pool" character varying, "vpc_id" integer, CONSTRAINT "UQ_d1dfaca1bedb81deb844d656b8a" UNIQUE ("load_balancer_name"), CONSTRAINT "PK_9e630b193d3416aa15430b97862" PRIMARY KEY ("id"))`);
