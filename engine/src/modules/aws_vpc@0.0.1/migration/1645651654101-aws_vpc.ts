...
export class awsVpc1645651654101 implements MigrationInterface {
    name = 'awsVpc1645651654101'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."aws_vpc_state_enum" AS ENUM('available', 'pending')`);
        await queryRunner.query(`CREATE TABLE "aws_vpc" ("id" SERIAL NOT NULL, "vpc_id" character varying NOT NULL, "cidr_block" character varying NOT NULL, "state" "public"."aws_vpc_state_enum", "is_default" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_8b6c8f56ab27571e63b780c06fe" PRIMARY KEY ("id"))`);
