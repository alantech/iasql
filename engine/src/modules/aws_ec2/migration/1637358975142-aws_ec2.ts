...
export class awsEc21637358975142 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "ami_image_type_enum" AS ENUM('kernel', 'machine', 'ramdisk')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_eb692930a8f8d93d0b9b083752"`);
        await queryRunner.query(`DROP INDEX "IDX_4e9018eb6d3190fe63deccaa7c"`);
        await queryRunner.query(`DROP TABLE "ami_tags_tag"`);
        await queryRunner.query(`DROP INDEX "IDX_65afc657dede946a97fc1c8cfb"`);
        await queryRunner.query(`DROP INDEX "IDX_1d46e384bbb2a9fde6378a86f1"`);
        await queryRunner.query(`DROP TABLE "ami_block_device_mappings_ebs_block_device_mapping"`);
        await queryRunner.query(`DROP INDEX "IDX_1e56d7b5240dfdaa218c6cd514"`);
        await queryRunner.query(`DROP INDEX "IDX_5f5813932818284a2968b65bbd"`);
        await queryRunner.query(`DROP TABLE "ami_product_codes_product_code"`);
        await queryRunner.query(`DROP INDEX "IDX_0bc4c00d7c86a81c48482a2773"`);
        await queryRunner.query(`DROP INDEX "IDX_ee3dfb3bef7cf8a5123b107167"`);
        await queryRunner.query(`DROP TABLE "instance_security_groups_aws_security_group"`);
        await queryRunner.query(`DROP INDEX "IDX_412917c37df7b4fd87130c5b32"`);
        await queryRunner.query(`DROP INDEX "IDX_bcc2197b46174377412f948c25"`);
        await queryRunner.query(`DROP TABLE "instance_type_availability_zones_availability_zone"`);
        await queryRunner.query(`DROP INDEX "IDX_2d2a09d2b55d7b6b89dc578db3"`);
        await queryRunner.query(`DROP INDEX "IDX_2ec996e8e52b74e2b833a0d15b"`);
        await queryRunner.query(`DROP TABLE "instance_type_regions_region"`);
        await queryRunner.query(`DROP INDEX "IDX_8feca90feb662840e93f69dbab"`);
        await queryRunner.query(`DROP INDEX "IDX_9c37dcb1e287c7a33b7faac34e"`);
        await queryRunner.query(`DROP TABLE "instance_type_supported_boot_modes_boot_mode"`);
        await queryRunner.query(`DROP INDEX "IDX_66dce3dea1b1105585c7799796"`);
        await queryRunner.query(`DROP INDEX "IDX_0d163b978403b500b47eba5d09"`);
        await queryRunner.query(`DROP TABLE "ins_typ_sup_vir_typ_vir_typ"`);
        await queryRunner.query(`DROP INDEX "IDX_58b6e3fd014da8bdf3e9fc688d"`);
        await queryRunner.query(`DROP INDEX "IDX_5a146f5a523d027bdecf53f868"`);
        await queryRunner.query(`DROP TABLE "instance_type_supported_root_device_types_device_type"`);
        await queryRunner.query(`DROP INDEX "IDX_f95cd9033d5c9c60f14e55d408"`);
        await queryRunner.query(`DROP INDEX "IDX_f7d8375e34b43c1d490eef07b5"`);
        await queryRunner.query(`DROP TABLE "instance_type_supported_usage_classes_usage_class"`);
        await queryRunner.query(`DROP INDEX "IDX_298b890565fa8e0a53b451738e"`);
        await queryRunner.query(`DROP INDEX "IDX_030e5f3fe8d268b47c57641506"`);
        await queryRunner.query(`DROP TABLE "vcpu_info_valid_threads_per_core_valid_threads_per_core"`);
        await queryRunner.query(`DROP INDEX "IDX_3c86374d2d8408fce1e851e7fd"`);
        await queryRunner.query(`DROP INDEX "IDX_fc2c10994fe41dabc3a3b5a303"`);
        await queryRunner.query(`DROP TABLE "vcpu_info_valid_cores_valid_core"`);
        await queryRunner.query(`DROP INDEX "IDX_a31ab49cbc6b1730dfe3224017"`);
        await queryRunner.query(`DROP INDEX "IDX_aa37e93922c084e42c465a396e"`);
        await queryRunner.query(`DROP TABLE "processor_info_supported_architectures_cpu_architecture"`);
        await queryRunner.query(`DROP INDEX "IDX_c5d67fa1330dd1981276ac4b8c"`);
        await queryRunner.query(`DROP INDEX "IDX_fcaa1b3100f75de6795abc2ff5"`);
        await queryRunner.query(`DROP TABLE "pla_gro_inf_sup_str_pla_gro_str"`);
        await queryRunner.query(`DROP INDEX "IDX_733bc8883afdead96d888557d3"`);
        await queryRunner.query(`DROP INDEX "IDX_1cc52b6e3ae855a309660e58e6"`);
        await queryRunner.query(`DROP TABLE "network_info_network_cards_network_card_info"`);
        await queryRunner.query(`DROP INDEX "IDX_b602fa24ec14bdcc6ea5c5a8a6"`);
        await queryRunner.query(`DROP INDEX "IDX_4f8487d0cd6197a3bbabaf669b"`);
        await queryRunner.query(`DROP TABLE "inference_accelerator_info_accelerators_inference_device_info"`);
        await queryRunner.query(`DROP INDEX "IDX_7a55525d1a014e05d9d4c8c52c"`);
        await queryRunner.query(`DROP INDEX "IDX_bd125596702150cb617f381d0f"`);
        await queryRunner.query(`DROP TABLE "gpu_info_gpus_gpu_device_info"`);
        await queryRunner.query(`DROP INDEX "IDX_2268e105277f5229c9f188f61c"`);
        await queryRunner.query(`DROP INDEX "IDX_31655488bf79fd765281eb3ee1"`);
        await queryRunner.query(`DROP TABLE "fpga_info_fpgas_fpga_device_info"`);
        await queryRunner.query(`DROP INDEX "IDX_1be4a83d4a7526415a1e7faccc"`);
        await queryRunner.query(`DROP INDEX "IDX_38834f60efde0aff7c836645a2"`);
        await queryRunner.query(`DROP TABLE "instance_storage_info_disks_disk_info"`);
        await queryRunner.query(`DROP TABLE "ami"`);
        await queryRunner.query(`DROP TYPE "ami_root_device_type_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "ami_image_type_enum"`);
