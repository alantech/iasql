...
import { awsEc21644459507734 } from './migration/1644459507734-aws_ec2'
...
export const AwsEc2Module: Module = new Module({
  ...
  migrations: {
    postinstall: awsEc21644459507734.prototype.up,
    preremove: awsEc21644459507734.prototype.down,
  },
});