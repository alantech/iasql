...
export class awsElb1637092695969 implements MigrationInterface {
    name = 'awsElb1637092695969'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "aws_load_balancer" ("id" SERIAL NOT NULL, "load_balancer_name" character varying NOT NULL, "load_balancer_arn" character varying, "dns_name" character varying, "canonical_hosted_zone_id" character varying, "created_time" TIMESTAMP WITH TIME ZONE, "scheme" "aws_load_balancer_scheme_enum" NOT NULL, "state" "aws_load_balancer_state_enum", "load_balancer_type" "aws_load_balancer_load_balancer_type_enum" NOT NULL, "ip_address_type" "aws_load_balancer_ip_address_type_enum" NOT NULL, "customer_owned_ipv4pool" character varying, CONSTRAINT "UQ_0da1f9c4e655b7b4b433e8e91d1" UNIQUE ("load_balancer_name"), CONSTRAINT "PK_8ae32084dac3c544fe7642f732e" PRIMARY KEY ("id"))`);
