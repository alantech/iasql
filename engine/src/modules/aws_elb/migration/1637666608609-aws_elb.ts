        ...
        await queryRunner.query(`
            ...
            begin
                ...
                do update set scheme = _scheme,
                    ...
                    vpc_id = (select id from aws_vpc where vpc_id = _vpc_id order by id desc limit 1);
                ...
                -- TODO: HANDLE BETTER SUBNETS UPDATES
                delete from aws_load_balancer_subnets_aws_subnet
                ...
                -- TODO: HANDLE BETTER AVAILABILITY ZONES UPDATES
                delete from aws_load_balancer_availability_zones_availability_zone
                where aws_load_balancer_id = load_balancer_id;
