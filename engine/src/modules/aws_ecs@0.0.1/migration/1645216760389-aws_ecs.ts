...
export class awsEcs1645216760389 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            $$;
        `);
        // Example of use: call create_or_update_ecs_service('test-12345', 'iasql', 'postgres:3', 1, 'FARGATE', 'REPLICA', array['default'], 'ENABLED', array['subnet-68312820'], 'iasql-postgresql', 'iasql-postgresql');
        await queryRunner.query(`
