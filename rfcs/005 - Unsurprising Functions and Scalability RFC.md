...
4. The engine is running a graphile worker process in the `scheduler.ts` file. This is also intermittently polling the job table using new connections for new jobs to execute. Eventually it finds it and starts executing the work.
