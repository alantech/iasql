...
title: Deploy a NodeJS App on AWS using EC2
date: 2022-12-23
unlisted: true
authors: [yrobla]
---

# Continuously Deploy a NodeJS app to AWS EC2 with one click

[CodePipeline](https://aws.amazon.com/codepipeline/) is a service provided by AWS to provide a fully automated [Continuous Delivery](https://en.wikipedia.org/wiki/Continuous_delivery) service.
...
The testing part is intentionally not covered by this scope, but would be an important part to cover when deploying to production.
