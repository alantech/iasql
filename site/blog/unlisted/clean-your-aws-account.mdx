...
To solve this problem you can use [AWS Nuke](https://github.com/rebuy-de/aws-nuke) or IaSQL. IaSQL is a tool that lets you manage your cloud account using a PostgreSQL database. IaSQL will backfill a PostgreSQL database with the contents of your cloud and with a query that schedules the deletion of the existing resources and their dependencies until your account is completely cleaned.
...
Please note that IaSQL can offer this cleanup only for the resources covered by our system. You can get a full coverage list <a href="https://github.com/iasql/iasql#aws-services-with-significant-api-coverage">hååere</a>.
