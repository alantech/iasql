...
You know the drill: we `INSERT` rows in the corresponding tables, and IaSQL will apply our desired changes to the cloud.
...
VALUES ('iasql', 'internet-facing', 'application', 'ipv4', default_aws_region());
