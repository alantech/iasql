...
```sql TheButton[Run SQL to check your endpoints]="Run SQL to check your endpoints"
...
```sql TheButton[Add missing endpoint interfaces]="Add missing endpoint interfaces"
...
By clicking on the button, our engine will auto-generate the missing endpoint interfaces and will allow you to preview the changes to be applied on your cloud. Once you are OK with the results,
you can uncomment the `iasql_commit` query and it will create the endpoints for you.
