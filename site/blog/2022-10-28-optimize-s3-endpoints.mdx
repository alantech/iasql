...
**Do you want to know if you have it properly configured? The followign query will check for active S3 VPC interface endpoints:**
...
By clicking on the button, our engine will auto-generate the missing interface endpoints and will
preview the changes to be applied on your cloud. Simply uncomment the final statement and run it to make the changes to your cloud account. <a href="https://docs.aws.amazon.com/vpc/latest/privatelink/create-interface-endpoint.html">Get more detail about interface endpoints.</a>
