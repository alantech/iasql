...
Endpoint interfaces cover a wide range of services such as S3, Lambda, API Gateway, etc...
...
For endpoint interfaces, access also can be tested using the named endpoint:
