...
After the process finishes, you will have your Ghost instance installed, publicly accessible through the public IP of the spinned instance. You can get the details of the public IP
of your instance querying for the metadata:
...
The initial Ghost installation will be available on the browser just query by http://<public_ip_address>:
