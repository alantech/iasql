...
This post is going to rely on EC2 to install the Ghost content. In order to access to the instance, it is recommended to setup some SSH keys, to later be able to access it for modifications and maintenance. So we will be generating some keys
