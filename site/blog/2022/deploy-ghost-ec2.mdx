...
SELECT
  *
FROM
  iasql_install ('aws_ec2');

SELECT
  *
FROM
  iasql_install ('aws_ec2_metadata');
...
After the process finishes, you will have your Ghost instance installed, publicly accessible through the public IP of the spinned instance:
