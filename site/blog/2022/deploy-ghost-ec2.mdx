...
FROM
  ...
  (
    VALUES
      (FALSE, 'tcp', 22, 22, '0.0.0.0/0', 'ghost_sg_group_rule_ssh'),
      (FALSE, 'tcp', 80, 80, '0.0.0.0/0', 'ghost_sg_group_rule_http'),
      (FALSE, 'tcp', 443, 443, '0.0.0.0/0', 'ghost_sg_group_rule_https'),
      (TRUE, 'tcp', 1, 65535, '0.0.0.0/0', 'ghost_sg_group_rule_egress')
  ) AS t (is_egress, ip_protocol, from_port, to_port, cidr_ipv4, description)
WHERE
  security_group.group_name = 'ghost_sg_group';
