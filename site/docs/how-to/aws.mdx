...
Sometimes, you may want or need to restrict your credentials to a specific region. To do this, you will need to create a custom policy that restricts access to AWS resources in that region. The following [guide](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_create.html) will walk you through creating a new policy. Your policy will need to look something like this:
